...
class TelegramController extends Controller
{
    ...
    public function startCommand()
    {
        ...
        $text = `
<b>Поздравьте наших бойцов с Днём защитника Отечества — отправьте им видео с личными и тёплыми пожеланиями.</b>
<blockquote>
...
<b><em>Поздравления принимаются только от жителей старше 18 лет.</em></b>
