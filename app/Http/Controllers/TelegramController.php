...
➡️ Если у вас ранее не получилось загрузите своё видео, то нажмите команду /start и пройдите процедуру заново.
    ...
    public function runNotify()
    {
        ini_set('max_execution_time', '300');
        $text = "
      ❗️Сегодня завершается приём поздравлений

Если вы ещё не успели прислать своё видео, то поторопитесь. А если уже отправляли, то предложите поучаствовать своим близким и знакомым — это их последний шанс.

🤍 Всего пара минут вашего времени поможет согреть душу одного из защитников на фронте.

➡️ Нажмите /start , ознакомьтесь с правилами, заполните анкету и загружайте видео.
        ";

        $keyboard = [
            [
                ["text" => "➡Я успею поздравить!", "callback_data" => "/start"
                ],
            ],
        ];
