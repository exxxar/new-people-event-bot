<template>
    <form @submit.prevent="submitForm">
      ...
      <textarea
          ...
          style="height: 100px"
      ></textarea>
            <label for="commentsInput">Дополнительные комментарии</label>
        </div>
        ...
        <button
            ...
            type="submit" class="btn btn-primary w-100 p-3">Стать клиентом</button>
    </form>
</template>
...
export default {
    ...
    methods: {
        submitForm() {
            ...
            this.jobStore.submitClientForm(this.form)
